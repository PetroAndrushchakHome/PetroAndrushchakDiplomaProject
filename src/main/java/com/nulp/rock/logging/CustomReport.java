...
public class CustomReport {
    ...
    private BufferedWriter fileObj;
    private  FileWriter fileHTML;
    private int stepNo = 1;

    private static String pass = "&#10004";
    private static String fail = "&#10008";

    private static long executionStartTime = System.currentTimeMillis();
    private static long executionEndTime = System.currentTimeMillis();
...
//			getVideosReport();
    ...
    public void getDashBoardReport() {
        ...
        try {
            ...
            dashBoard = dashBoard + "<td id=\"rowheight1\" align=center width=17%><a href=\"https://www.google.com.ua/\"><img width=90% height=60% src=\"CC\"/></a></td>";
            ...
            dashBoard = dashBoard + "<a class=\"animate\" href=\"DashBoard.html\"><div left' class=\"home\"><img width=28px height=25px alt=\"Home\" src=\"\"/></div></a></body></html>";
...
//
    ...
    public void sendEmail() throws Exception {
        ...
        String to = "petroandrushchak@gmail.com";
        String cc = "";
        String bcc = "";
        ...
        try {
            ...
            message.setSubject("Automation - google" + " Project Automation Report");

            BodyPart messageBodyPart = new MimeBodyPart();

            messageBodyPart.setText("Hi Team,"
                    + '\n' + '\n'
                    + "PFA" + "Automation - google" + " Automation Report along with this email"
                    + '\n' + '\n'
                    + "Thanks and Regards"
                    + '\n' + '\n'
                    + "Petro R");
...
//	}
    ...
    public void setScriptStartTime(long scriptStartTime){
    ...
    public static void setFailedTests(int failedTests) {
        CustomReport.failedTests = failedTests;
    }
    ...
    public static void setPassedTests(int passedTests) {
        CustomReport.passedTests = passedTests;
    }
    ...
    public static void setSkippedTests(int skippedTests) {
        CustomReport.skippedTests = skippedTests;
    }
    ...
    public static void setPassCount(int passCount) {
        CustomReport.passCount = passCount;
    }
    ...
    public static void setFailCount(int failCount) {
        CustomReport.failCount = failCount;
    }
    ...
    public static void setSkipCount(int skipCount) {
        CustomReport.skipCount = skipCount;
    }
    ...
    public static void setTestStatus(boolean testStatus) {
        CustomReport.testStatus = testStatus;
    }
